...
########
# Obtain the type of Mosaic and the path to the image from command line arguments
########
try:
...
print('\nLoad the model trained with {} instances of normal Mosaic puzzles'.format(numOfData))
